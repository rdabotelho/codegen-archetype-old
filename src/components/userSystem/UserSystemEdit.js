...
class UserSystemEdit extends Component {
    ...
    componentDidMount() {
        ...
        UserSystemService.getUserSystemById(id).then(response => {
            this.setState({
    ...
    onSubmit(e) {
        ...
        UserSystemService.updateUserSystem(obj).then(response => {
            NotificationManager.success("UserSystem updated successfully", 'Success')
        })
        .catch(function (error) {
            console.log(error);
        });
